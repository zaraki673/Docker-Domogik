...
## init a database
mysql -h localhost -p domopass -e "CREATE DATABASE if not exists domogik;"
mysql -h localhost -p domopass -e "GRANT ALL PRIVILEGES ON domogik.* to domogik@ IDENTIFIED BY 'domopass';"
